...
public class ActionTypesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RealmResults<actionType> entityes = realm.where(actionType.class).findAll();

        arrayList = new ArrayList<>();
        HashMap<String, String> map;

        for (actionType Entity: entityes) {
            map = new HashMap<>();
    ...
    public void openCreateActivity() {
        Intent intent = new Intent(this, CreateActionTypeActivity.class);
