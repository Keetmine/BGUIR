...
public class EmployeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RealmResults<employee> entityes = realm.where(employee.class).findAll();
        ...
        for (employee Entity: entityes) {
            map = new HashMap<>();
            map.put("Name", Entity.getFio());
    ...
    public void openCreateActivity() {
        Intent intent = new Intent(this, CreateEmployeActivity.class);
