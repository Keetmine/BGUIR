...
{********************************************************************}
begin
  IsoMatrix[1][1]:= -sqrt(1/2);             // cos b          // ���.1 �����.1
  IsoMatrix[1][2]:= sqrt(1/2)*sqrt(1/3);    // sin a sin b    // ���.1 �����.2
  IsoMatrix[1][3]:= 0;                      // 0              // ���.1 �����.3
  IsoMatrix[2][1]:= 0;                      // 0              // ���.2 �����.1
  IsoMatrix[2][2]:= -sqrt(2/3);             // cos a          // ���.2 �����.2
  IsoMatrix[2][3]:= 0;                      // 0              // ���.2 �����.3
  IsoMatrix[3][1]:= sqrt(1/2);              // sin b          // ���.3 �����.1
  IsoMatrix[3][2]:= sqrt(1/2)*sqrt(1/3);    // - sin a cos b  // ���.3 �����.2
  IsoMatrix[3][3]:= 0;                      // 0              // ���.3 �����.3
end;
...
begin
  ...
  RebroArr[6].b:= PointsArr[6];              // ����� 1..6 = ������ ���������
  RebroArr[6].e:= PointsArr[1];
  RebroArr[12].b:= PointsArr[12];
  RebroArr[12].e:= PointsArr[7];             // ����� 7..12 = ������� ���������
  for i:=1 to 6 do
  begin
    RebroArr[i+12].b:= PointsArr[i];         // ����� 12..18 = ������� �����
